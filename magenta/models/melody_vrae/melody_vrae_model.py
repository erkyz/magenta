...
class MelodyVraeConfig(events_vrae_model.EventSequenceRnnConfig):
  """Stores a configuration for a MelodyVrae.
  ...
  def __init__(self, details, encoder_decoder, hparams,
    ...
    super(MelodyVraeConfig, self).__init__(details, encoder_decoder, hparams)
...
default_configs = {
    ...
    'attention_rnn': MelodyVraeConfig(
        magenta.protobuf.generator_pb2.GeneratorDetails(
            id='attention_rnn',
